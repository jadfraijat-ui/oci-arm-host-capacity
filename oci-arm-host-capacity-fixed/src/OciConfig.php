...
class OciConfig
{
    ...
    public function setAssignPublicIp(bool $assign): void
    {
        $this->assignPublicIp = $assign;
    }
    ...
    public function setIpv6SubnetId(string $subnetId): void
    {
        $this->ipv6SubnetId = $subnetId;
    }
}
